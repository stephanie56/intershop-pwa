...
const getViewcontextsState = createSelector(
  getContentState,
  state => state.viewcontexts
);

export const getViewcontextsLoading = createSelector(
  getViewcontextsState,
  state => state.loading
);

export const getViewcontextsError = createSelector(
  getViewcontextsState,
  state => state.error
);

export const {
  selectEntities: getViewcontextEntities,
  selectAll: getViewcontexts,
  selectTotal: getNumberOfViewcontexts,
} = viewcontextsAdapter.getSelectors(getViewcontextsState);
